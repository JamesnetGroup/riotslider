...
왜냐하면 WPF의 모든 소스코드가 GitHub 레포지터리를 통해 오픈소스로 공개 및 관리되고 있기 때문입니다. 따라서 우리는 필요에 따라 언제든지 GitHub 레포지터리에 접근해서 해당 컨트롤을 찾아 분석하는 것이 가능하기 때문에 더 이상 급할 필요가 없습니다. 더 피곤해지긴 했어도, 불평할 필요 없죠.
